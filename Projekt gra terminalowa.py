...
def wybor_1():  # wyskakuje po naciśnięciu przycisk_1
    ...
    if tura == 1:
        ...
        przycisk_3.configure(text = "dżokej")
        ...
        tura = tura + 15
    # elif tura == 3 or tura == 12 or tura == 21 or tura == 22 or tura == 30 or tura == 40:
        #[3 -> spóźnienie(1), Mickiewicz(1), Alternatywka(1)][12 -> spóźnienie(1), Słowacki(10), Alter.(1) | Piżama(10),przepraszam(1),alter(1)]
        #[21 -> piżama(10),pyskowanie(10),alternatywka(1)][22 ->spóźnienie(1),Mickiewicz(1),dżokej(20)][30 -> piżama(10),pyskowanie(10),koniara(10)]
        #[40 ->piżama(10),pyskowanie(10),dżokej(10)]
    elif tura > 25 and tura < 46:
        if sympatia_ludzi == 2 or sympatia_ludzi == 4:
...
def wybor_3():
    ...
    global sympatia_ludzi
    # tura = tura + 20
    # if tura == 3 or tura == 12 or tura == 21 or tura == 22 or tura == 30 or tura == 40:
    if tura > 25 and tura < 46:
        if sympatia_ludzi == 2 or sympatia_ludzi == 4:
